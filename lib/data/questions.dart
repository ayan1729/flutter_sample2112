...
const questions = [
  ...
  QuizQuestions("3. Which 1970s computer first featured a GUI?",
  ...
  QuizQuestions(
      ...
      "OSIRIS-REx"),
  QuizQuestions(
      "5. Where was India's first semiconductor fabrication plant set up?",
  ...
  QuizQuestions(
      ...
      "IBM"),
  QuizQuestions(
      "7. Which Indian state built the first post office using 3D printing technology?",
